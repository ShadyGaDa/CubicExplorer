...
type
  ...
  private
    ...
    FRootName: DOMString;
    FDummy: DOMString;
    FPathStack: array of AnsiString;
    FPathCount: Integer;
    FPathDirty: Boolean;
    FElement: TDOMElement;
    procedure DoSetFilename(const AFilename: AnsiString; ForceReload: Boolean);
    ...
    function DoFindNode(const APath: AnsiString; var Ident: DOMString;
      Flags: TPathFlags): TDomElement;
    function FindNode(const APath: AnsiString; out Ident: DOMString;
      Flags: TPathFlags): TDOMElement;
  protected
    Doc: TXMLDocument;
    FModified: Boolean;
  ...
  public
    ...
    procedure OpenKey(const aPath: AnsiString);
    procedure CloseKey;
    procedure ResetKey;

    function  GetValue(const APath: AnsiString; const ADefault: AnsiString): AnsiString; overload;
    function  GetValue(const APath: AnsiString; ADefault: Integer): Integer; overload;
    function  GetValue(const APath: AnsiString; ADefault: Boolean): Boolean; overload;
    procedure SetValue(const APath: AnsiString; const AValue: AnsiString); overload;
    ...
    procedure SetDeleteValue(const APath: AnsiString; const AValue, DefValue: AnsiString); overload;
    procedure SetDeleteValue(const APath: AnsiString; AValue, DefValue: Integer); overload;
    procedure SetDeleteValue(const APath: AnsiString; AValue, DefValue: Boolean); overload;
...
function TXMLConfig.GetValue(const APath: AnsiString; const ADefault: AnsiString): AnsiString;
var
  Node: TDOMElement;
  Attr: TDOMAttr;
  Ident: DOMString;
...
procedure TXMLConfig.SetValue(const APath: AnsiString; const AValue: AnsiString);
var
  Node: TDOMElement;
  Attr: TDOMAttr;
  Ident: DOMString;
...
procedure TXMLConfig.SetDeleteValue(const APath: AnsiString; const AValue, DefValue: AnsiString);
begin
...
procedure TXMLConfig.SetDeleteValue(const APath: AnsiString; AValue,
  DefValue: Integer);
begin
  if AValue = DefValue then
    DeleteValue(APath)
...
function TXMLConfig.FindNode(const APath: AnsiString; out Ident: DOMString;
  Flags: TPathFlags): TDOMElement;
var
  I: Integer;
begin
...
function TXMLConfig.DoFindNode(const APath: AnsiString; var Ident: DOMString;
  Flags: TPathFlags): TDomElement;
var
...
begin
  ...
  begin
    ...
    begin
      SetString(Ident, PAnsiChar(@APath[StartPos]), PathLen-StartPos+1);
      exit;
    end;
...
procedure TXMLConfig.DoSetFilename(const AFilename: AnsiString; ForceReload: Boolean);
begin
...
procedure TXMLConfig.OpenKey(const aPath: AnsiString);
begin
  if aPath <> '' then
  begin
