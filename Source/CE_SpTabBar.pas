...
uses
  // CE Units
  fCE_TabPage, CE_Layout, CE_AppSettings, CE_Toolbar, CE_FileUtils,
  // SpTBX
  ...
  ExtCtrls, Graphics, StrUtils, ShlObj, Menus, Contnrs, ImgList, Types;
  ...
  type
    ...
    protected
      procedure DoDrawCaption(ACanvas: TCanvas; ClientAreaRect: TRect; State:
          TSpTBXSkinStatesType; var ACaption: String; var CaptionRect: TRect; var
    ...
    private
      ...
      procedure SetNewTabPath(const Value: String);
    ...
    published
      ...
      property NewTabPath: String read fNewTabPath write SetNewTabPath;
...
uses
//  CE_VistaFuncs
  Main, dCE_Actions, fCE_FileView, Math;
...
//    SpDrawXPTabControlBackground(FBackground.Canvas, ARect, Color, TabPosition = ttpBottom, SkinType);
    SpDrawXPTabControlBackground(FBackground.Canvas, ARect, Color, TabPosition = ttpBottom);
    PaintDefault:= false;
  end;
end;
...
//      SpDrawXPToolbar(Self, B.Canvas, R, PaintOnNCArea, TabBackgroundBorders and (T <> sknNone), skncTabToolbar);
      SpDrawXPToolbar(Self, B.Canvas, R, PaintOnNCArea, TabBackgroundBorders, skncTabToolbar);
...
//    SpDrawXPToolbar(Self, ACanvas, ARect, PaintOnNCArea, TabBackgroundBorders and (T <> sknNone), skncTabToolbar);
    SpDrawXPToolbar(Self, ACanvas, ARect, PaintOnNCArea, TabBackgroundBorders, skncTabToolbar);
end;
...
{-------------------------------------------------------------------------------
  Set NewTabPath
-------------------------------------------------------------------------------}
procedure TCETabSettings.SetNewTabPath(const Value: String);
var
  ws: String;
  pidl: PItemIDList;
begin
...
procedure TCEScrollArrowItem.DoDrawCaption(ACanvas: TCanvas; ClientAreaRect:
    TRect; State: TSpTBXSkinStatesType; var ACaption: String; var
