...
type
  ...
  public
    ...
    procedure LoadNamespace(Path: String);
  ...
  public
    Settings: TCEDriveBarSettings;
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure HandleContextMenuCmd(Namespace: TNamespace; Verb: String;
  ...
  TCEDriveBarSettings = class(TPersistent)
  private
...
-------------------------------------------------------------------------------}
procedure TCEShellToolbarItem.LoadNamespace(Path: String);
begin
  if assigned(Namespace) then
  FreeAndNil(Namespace);
...
//  SetVistaFont(Font);
  ...
  Settings:= TCEDriveBarSettings.Create;
