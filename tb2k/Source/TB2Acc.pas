...
type
  ...
  ITBAccessible = interface(IDispatch)
    ...
    function get_accName(varChild: TTBVariant; out pszName: String): HRESULT; stdcall;
    function get_accValue(varChild: TTBVariant; out pszValue: String): HRESULT; stdcall;
    function get_accDescription(varChild: TTBVariant; out pszDescription: String): HRESULT; stdcall;
    ...
    function get_accHelp(varChild: TTBVariant; out pszHelp: String): HRESULT; stdcall;
    function get_accHelpTopic(out pszHelpFile: String; varChild: TTBVariant; out pidTopic: Integer): HRESULT; stdcall;
    function get_accKeyboardShortcut(varChild: TTBVariant; out pszKeyboardShortcut: String): HRESULT; stdcall;
    ...
    function get_accDefaultAction(varChild: TTBVariant; out pszDefaultAction: String): HRESULT; stdcall;
    ...
    function put_accName(varChild: TTBVariant; const pszName: String): HRESULT; stdcall;
    function put_accValue(varChild: TTBVariant; const pszValue: String): HRESULT; stdcall;
  end;
  {$ELSE}
  TTBVariant = TObject;
  [ComImport,
  ...
  ITBAccessible = interface
    ...
    [PreserveSig]
    function get_accName(varChild: TTBVariant; out pszName: String): HRESULT;
    [PreserveSig]
    function get_accValue(varChild: TTBVariant; out pszValue: String): HRESULT;
    [PreserveSig]
    function get_accDescription(varChild: TTBVariant; out pszDescription: String): HRESULT;
    [PreserveSig]
    ...
    [PreserveSig]
    function get_accHelp(varChild: TTBVariant; out pszHelp: String): HRESULT;
    [PreserveSig]
    function get_accHelpTopic(out pszHelpFile: String; varChild: TTBVariant; out pidTopic: Integer): HRESULT;
    [PreserveSig]
    function get_accKeyboardShortcut(varChild: TTBVariant; out pszKeyboardShortcut: String): HRESULT;
    [PreserveSig]
    function get_accFocus(out pvarID: TTBVariant): HRESULT;
    [PreserveSig]
    function get_accSelection(out pvarChildren: TTBVariant): HRESULT;
    [PreserveSig]
    function get_accDefaultAction(varChild: TTBVariant; out pszDefaultAction: String): HRESULT;
    [PreserveSig]
    ...
    [PreserveSig]
    function put_accName(varChild: TTBVariant; const pszName: String): HRESULT;
    [PreserveSig]
    function put_accValue(varChild: TTBVariant; const pszValue: String): HRESULT;
  end;
  {$ENDIF}
  ...
  private
    ...
    function get_accDefaultAction(varChild: TTBVariant; out pszDefaultAction: String): HRESULT; {$IFNDEF CLR}stdcall;{$ENDIF}
    function get_accDescription(varChild: TTBVariant; out pszDescription: String): HRESULT; {$IFNDEF CLR}stdcall;{$ENDIF}
    function get_accFocus(out pvarID: TTBVariant): HRESULT; {$IFNDEF CLR}stdcall;{$ENDIF}
    function get_accHelp(varChild: TTBVariant; out pszHelp: String): HRESULT; {$IFNDEF CLR}stdcall;{$ENDIF}
    function get_accHelpTopic(out pszHelpFile: String; varChild: TTBVariant; out pidTopic: Integer): HRESULT; {$IFNDEF CLR}stdcall;{$ENDIF}
    function get_accKeyboardShortcut(varChild: TTBVariant; out pszKeyboardShortcut: String): HRESULT; {$IFNDEF CLR}stdcall;{$ENDIF}
    function get_accName(varChild: TTBVariant; out pszName: String): HRESULT; {$IFNDEF CLR}stdcall;{$ENDIF}
    ...
    function get_accValue(varChild: TTBVariant; out pszValue: String): HRESULT; {$IFNDEF CLR}stdcall;{$ENDIF}
    function put_accName(varChild: TTBVariant; const pszName: String): HRESULT; {$IFNDEF CLR}stdcall;{$ENDIF}
    function put_accValue(varChild: TTBVariant; const pszValue: String): HRESULT; {$IFNDEF CLR}stdcall;{$ENDIF}
  {$IFDEF CLR}
  strict protected
...
function TTBViewAccObject.get_accDefaultAction(varChild: TTBVariant;
  out pszDefaultAction: String): HRESULT;
begin
  Result := S_FALSE;
end;

function TTBViewAccObject.get_accDescription(varChild: TTBVariant;
  out pszDescription: String): HRESULT;
begin
  Result := S_FALSE;
end;
...
function TTBViewAccObject.get_accHelp(varChild: TTBVariant;
  out pszHelp: String): HRESULT;
begin
  Result := S_FALSE;
end;

function TTBViewAccObject.get_accHelpTopic(out pszHelpFile: String;
...
function TTBViewAccObject.get_accKeyboardShortcut(varChild: TTBVariant;
  out pszKeyboardShortcut: String): HRESULT;
begin
  try
    if not Check(varChild, Result) then
      Exit;
...
function TTBItemViewerAccObject.get_accHelpTopic(out pszHelpFile: String;
  varChild: TTBVariant; out pidTopic: Integer): HRESULT;
begin
  pidTopic := 0;  { Delphi doesn't implicitly clear Integer 'out' parameters }
  Result := S_FALSE;
