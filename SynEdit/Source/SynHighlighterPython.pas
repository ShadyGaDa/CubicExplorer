...
type
  ...
  protected
    ...
    function GetKeywordIdentifiers: TuStringList;
    property Keywords: TuStringList read FKeywords;
...
var
  GlobalKeywords: TuStringList;

function TSynPythonSyn.GetKeywordIdentifiers: TuStringList;
const
...
begin
  ...
  begin
    ...
    GlobalKeywords := TuStringList.Create;
...
begin
  ...
  begin
    // TuStringList is not case sensitive!
...
procedure TSynPythonSyn.uStringProc;
begin
