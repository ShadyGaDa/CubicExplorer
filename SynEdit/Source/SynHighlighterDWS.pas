...
function TSynDWSSyn.HashKey(Str: PChar{!}): Cardinal;
var
  c: Word;
begin
  Result := 0;
...
function TSynDWSSyn.IdentKind(MayBe: PChar{!}): TtkTokenKind;
var
  Key: Cardinal;
begin
  FToIdent := MayBe;
...
// IsIdentChar
//
function TSynDWSSyn.IsIdentChar(AChar: Char{!}): Boolean;
begin
