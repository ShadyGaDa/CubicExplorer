...
type
  ...
  private
    ...
    { Accessor methods }
    function GetItems: TuStrings;
    procedure SetItems(const Value: TuStrings);
  protected
...
{$ENDIF}
  ...
  public
    ...
    property Items: TuStrings read GetItems write SetItems;
...
begin
  ...
  begin
    EditLine := SynUpperCase(EditLine);
    SearchString := SynUpperCase(SearchString);
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if FoundText = SynUpperCase(FoundText) then
          Correction := SynUpperCase(Correction)
        else
        begin
          if FoundText = SynLowerCase(FoundText) then
            Correction := SynLowerCase(Correction)
          else
          begin
...
function TCustomSynAutoCorrect.GetItems: TuStrings;
begin
  Result := FItems;
end;
...
procedure TCustomSynAutoCorrect.SetItems(const Value: TuStrings);
begin
  FItems.Assign(Value);
end;
