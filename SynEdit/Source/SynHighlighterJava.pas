...
{$Q-}
function TSynJavaSyn.HashKey(Str: PChar{!}): Cardinal;
begin
  Result := 0;
...
function TSynJavaSyn.IsIdentChar(AChar: Char{!}): Boolean;
begin
  case AChar of
    '_', '$', '0'..'9', 'a'..'z', 'A'..'Z', Char{!}(#$00C0)..Char{!}(#$00D6),
      Char{!}(#$00D8)..Char{!}(#$00F6), Char{!}(#$00F8)..Char{!}(#$00FF):
      Result := True;
    else
      Result := False;
  end;
