...
function LoadDFMFile2Strings(const AFile: String{!}; AStrings: TuStrings;
...
{$ENDIF}
function SaveStrings2DFMFile(AStrings: TuStrings;
  const AFile: String{!}): Integer; {$IFNDEF UNICODE} overload; {$ENDIF}
{$IFNDEF UNICODE}
...
function SaveStrings2DFMFile(AStrings: TuStrings; const AFile: String{!}): Integer;
var
  Src, Dest: TStream;
{$IFNDEF UNICODE}
