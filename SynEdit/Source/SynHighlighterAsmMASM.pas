...
//  Operators: uString = 'abs,addr,and,dup,eq,ge,'+
//                              'gt,high,high32,highword,imagerel,le,length,lengthof,' +
//                              'low,low32,lowword,lroffset,lt,mask,mod,ne,not,offset,' +
//                              'opattr,or,ptr,seg,shl,.type,sectionrel,short,shr,' +
//                              'size,sizeof,this,type,width,xor';
...
//  ProcessorSpecification: uString =
...
//
//  StringControl: uString = 'catstr,instr,sizestr,substr';
//
//  Miscellaneous: uString = '=,comment,display,echo,equ,%out';
...
//{$Q-}
function TSynAsmMASMSyn.HashKey(Str: PChar{!}): Cardinal;
begin
  Result := 0;
...
function TSynAsmMASMSyn.IdentKind(MayBe: PChar{!}): TtkTokenKind;
var
  Entry: TSynHashEntry;
begin
  FToIdent := MayBe;
