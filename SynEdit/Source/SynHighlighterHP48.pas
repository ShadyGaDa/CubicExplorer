...
type
  ...
  protected
    ...
    function GetStringList: TuStrings;
    procedure SetStringList(const Value: TuStrings);
  public
    ...
    property StringList: TuStrings read GetStringList write SetStringList;
...
function TSpeedStringList.GetStringList: TuStrings;
var
  i, j: Integer;
begin
  Result := TuStringList.Create;
  for i := Low(FDatas) to High(FDatas) do
    for j := 0 to FDatasUsed[i] - 1 do
...
procedure TSpeedStringList.SetStringList(const value: TuStrings);
var
  i: Integer;
begin
  clear;
