...
type
  ...
  protected
    ...
    FCompletions: TuStrings;
    FCompletionComments: TuStrings;
    FCompletionValues: TuStrings;
    ...
    function GetCompletions: TuStrings;
    function GetCompletionComments: TuStrings;
    function GetCompletionValues: TuStrings;
    function GetEditorCount: Integer;
    function GetNthEditor(Index: Integer): TCustomSynEdit;
    procedure SetAutoCompleteList(Value: TuStrings); virtual;
  ...
  public
    ...
    property Completions: TuStrings read GetCompletions;
    property CompletionComments: TuStrings read GetCompletionComments;
    property CompletionValues: TuStrings read GetCompletionValues;
...
begin
  ...
  TuStringList(FAutoCompleteList).OnChange := CompletionListChanged;
  FCompletions := TuStringList.Create;
  FCompletionComments := TuStringList.Create;
  FCompletionValues := TuStringList.Create;
...
function TCustomSynAutoComplete.GetCompletions: TuStrings;
begin
  if not FParsed then
    ParseCompletionList;
  Result := FCompletions;
...
function TCustomSynAutoComplete.GetCompletionComments: TuStrings;
begin
  if not FParsed then
    ParseCompletionList;
...
function TCustomSynAutoComplete.GetCompletionValues: TuStrings;
begin
  if not FParsed then
    ParseCompletionList;
...
procedure TCustomSynAutoComplete.SetAutoCompleteList(Value: TuStrings);
begin
