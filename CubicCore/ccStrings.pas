...
//   - Jcl-Wide-String.pas (JCL library)
...
-------------------------------------------------------------------------------}
  ...
  function WideCompareText(const S1, S2: String): SizeInt;
  function WideCompareStr(const S1, S2: String): SizeInt;
  function WidePos(const SubStr, Str: String): SizeInt;
  ...
  function WideStrNew(const Str: String): PWideChar; overload;
  ...
  function WideIsSameStr(const S1, S2: String): Boolean;
  function WideIsSameText(const S1, S2: String): Boolean;
  function  WideLowCaseFolding(const Ch: WideChar): String;
  function  WideLowerCase(const S: String): String;
  function  WideUpCase(const Ch: WideChar): WideChar;
  function  WideUpCaseFolding(const Ch: WideChar): String;
  function  WideUpperCase(const S: String): String;
  function WideGetNextItem(var AFromString: String; const ASeparator:
      WideChar; ADeleteFromString: Boolean = true; const ADefault: String =
      ''): String;
  procedure WideTrunkFromNull(var AStr: String);
  procedure AnsiTrunkFromNull(var AStr: AnsiString);

  function WideReplaceChar(const Find: WideChar; const Replace: String; const
      AStr: String): String;
  function WideCountChar(const AChar: WideChar; const AStr: String): Integer;
      overload;

function WideRectToStr(ARect: TRect): String;

function WidePointToStr(APoint: TPoint): String;

function WideStrToRectDef(const AStr: String; ADefaultRect: TRect): TRect;

function WideStrToPointDef(const AStr: String; ADefaultPoint: TPoint):
    TPoint;
...
-------------------------------------------------------------------------------}
function LocateFoldingLowerCase(const Ch: WideChar): String;
begin
  if Ch = #$0130 then
    Result := #$0069#$0307
  else
...
-------------------------------------------------------------------------------}
function LocateFoldingUpperCase(const Ch: WideChar): String;
begin
  if Ord(Ch) < $00DF then
    Result := '' else
  if Ord(Ch) <= $0587 then
...
{-------------------------------------------------------------------------------
  WideStrNew (JCL)
-------------------------------------------------------------------------------}
function WideStrNew(const Str: String): PWideChar;
begin
