...
function WideExpandFileName(const FileName, BaseDir: WideString): WideString; overload;
...
function WideExtractFileExt(const FileName: WideString; RemoveDot: Boolean = false): WideString;
