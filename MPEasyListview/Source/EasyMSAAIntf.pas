...
// *********************************************************************//
  ...
  IAccessible = interface(IDispatch)
    ...
    function Get_accName(varChild: OleVariant; out pszName: String): HResult; stdcall;
    function Get_accValue(varChild: OleVariant; out pszValue: String): HResult; stdcall;
    function Get_accDescription(varChild: OleVariant; out pszDescription: String): HResult; stdcall;
    function Get_accRole(varChild: OleVariant; out pvarRole: OleVariant): HResult; stdcall;
    function Get_accState(varChild: OleVariant; out pvarState: OleVariant): HResult; stdcall;
    function Get_accHelp(varChild: OleVariant; out pszHelp: String): HResult; stdcall;
    function Get_accHelpTopic(out pszHelpFile: String; varChild: OleVariant;
                              out pidTopic: Integer): HResult; stdcall;
    function Get_accKeyboardShortcut(varChild: OleVariant; out pszKeyboardShortcut: String): HResult; stdcall;
    function Get_accFocus(out pvarChild: OleVariant): HResult; stdcall;
    function Get_accSelection(out pvarChildren: OleVariant): HResult; stdcall;
    function Get_accDefaultAction(varChild: OleVariant; out pszDefaultAction: String): HResult; stdcall;
    ...
    function Set_accName(varChild: OleVariant; const pszName: String): HResult; stdcall;
    function Set_accValue(varChild: OleVariant; const pszValue: String): HResult; stdcall;
  end;
...
// *********************************************************************//
  ...
  IAccessibleDisp = dispinterface
    ...
    property accName[varChild: OleVariant]: String dispid -5003;
    property accValue[varChild: OleVariant]: String dispid -5004;
    property accDescription[varChild: OleVariant]: String readonly dispid -5005;
    ...
    property accHelp[varChild: OleVariant]: String readonly dispid -5008;
    property accHelpTopic[out pszHelpFile: String; varChild: OleVariant]: Integer readonly dispid -5009;
    property accKeyboardShortcut[varChild: OleVariant]: String readonly dispid -5010;
    property accFocus: OleVariant readonly dispid -5011;
    property accSelection: OleVariant readonly dispid -5012;
    property accDefaultAction[varChild: OleVariant]: String readonly dispid -5013;
