...
type
  ...
  public
    ...
    function ReadStringW(S: TStream): String;
...
//    procedure WritePublishedProperties(S: TStream; Instance: TObject; RecurseSubClasses: Boolean);
    ...
    procedure WriteStringW(S: TStream; Value: String);
  end;
  ...
  public
    ...
    procedure WriteStringW(const Value: String);
  end;
...
function TCommonMemoryStreamHelper.ReadStringW(S: TStream): String;
var
  i: Integer;
begin
  i := ReadInteger(S);
        ...
        case PropList[i].PropType^^.Kind of
          ...
          tkWString, tkLString:
            begin
              ...
              SetWideStrProp(Instance, PropList[i], ReadStringW(S));
            end;
          tkInt64:
            begin
    ...
    try
      ...
      begin
        case PropList[i].PropType^^.Kind of
          ...
          tkWString, tkLString:
            begin
              WriteStringW(S, GetWideStrProp(Instance, PropList[i]));
            end;
          tkInt64:
            begin
...
procedure TCommonMemoryStreamHelper.WriteStringW(S: TStream; Value: String);
begin
  WriteInteger(S, Length(Value));
...
function TCommonStream.ReadStringW: String;
var
  Size: LongWord;
begin
  ReadBuffer(Size, SizeOf(LongWord));
...
procedure TCommonStream.WriteStringW(const Value: String);
var
  Size: LongWord;
begin
  Size := Length(Value);
...
procedure TCommonHintWindow.SetCaption(const Value: String);
begin
  FCaption := Value;
  AnsiCaption := Value;
end;
