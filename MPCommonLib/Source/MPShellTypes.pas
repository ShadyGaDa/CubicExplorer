...
// *********************************************************************//
  IWebBrowser = interface(IDispatch)
    ...
    procedure Navigate(const URL: String; var Flags: OleVariant;
    ...
    function  Get_Type_: String; safecall;
    ...
    function  Get_LocationName: String; safecall;
    function  Get_LocationURL: String; safecall;
    ...
    property Type_: String read Get_Type_;
    property Left: Integer read Get_Left write Set_Left;
    property Top: Integer read Get_Top write Set_Top;
    property Width: Integer read Get_Width write Set_Width;
    property Height: Integer read Get_Height write Set_Height;
    property LocationName: String read Get_LocationName;
    property LocationURL: String read Get_LocationURL;
...
// *********************************************************************//
  IWebBrowserApp = interface(IWebBrowser)
    ...
    procedure PutProperty(const Property_: String; vtValue: OleVariant); safecall;
    function  GetProperty(const Property_: String): OleVariant; safecall;
    function  Get_Name: String; safecall;
    function  Get_HWND: Integer; safecall;
    function  Get_FullName: String; safecall;
    function  Get_Path: String; safecall;
    ...
    function  Get_StatusText: String; safecall;
    procedure Set_StatusText(const StatusText: String); safecall;
...
// *********************************************************************//
  FolderItem = interface(IDispatch)
    ...
    function Get_Parent: IDispatch; safecall;
    function Get_Name: String; safecall;
    procedure Set_Name(const pbs: String); safecall;
    function Get_Path: String; safecall;
...
// *********************************************************************//
  FolderItem2 = interface(FolderItem)
    ...
    function ExtendedProperty(const bstrPropName: String): OleVariant; safecall;
  end;
...
// *********************************************************************//
  FolderItems3 = interface(FolderItems2)
    ...
    procedure Filter(grfFlags: Integer; const bstrFileSpec: String); safecall;
...
// *********************************************************************//
  Folder = interface(IDispatch)
    ...
    function Get_Title: String; safecall;
    function Get_Application: IDispatch; safecall;
    function Get_Parent: IDispatch; safecall;
    function Get_ParentFolder: Folder; safecall;
    function Items: FolderItems; safecall;
    function ParseName(const bName: String): FolderItem; safecall;
    procedure NewFolder(const bName: String; vOptions: OleVariant); safecall;
    ...
    function GetDetailsOf(vItem: OleVariant; iColumn: SYSINT): String; safecall;
...
// *********************************************************************//
  IShellFolderViewDual = interface(IDispatch)
    ...
    function PopupItemMenu(const pfi: FolderItem; vx: OleVariant; vy: OleVariant): String; safecall;
