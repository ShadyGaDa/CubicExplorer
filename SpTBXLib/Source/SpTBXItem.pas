...
type
  ...
  public
    ...
    function GetShortCutText: String; // Reintroduce to support unicode shortcut text
  ...
  public
    function GetCaptionText: String; reintroduce; virtual; // Hides the inherited TB2K GetCaptionText function
    function GetHintText: String; reintroduce; virtual; // Hides the inherited TB2K GetHintText function
...
function TSpTBXCustomItem.GetShortCutText: String;
var
  P: Integer;
begin
  P := Pos(#9, Caption);
...
function TSpTBXItemViewer.GetCaptionText: String;
begin
...
function TSpTBXItemViewer.GetHintText: String;
var
  I: Integer;
  S: string;
begin
