...
//    {$IFEND}
  ...
  published
    ...
    // Don't let the streaming system store the Strings, use DefineProperties instead
    property EditCaption: String read FEditCaption write SetEditCaption; // Hides the inherited EditCaption
    property EditImageIndex: TImageIndex read FEditImageIndex write FEditImageIndex default -1;
    property Text: String read FText write SetText; // Hides the inherited Text
  ...
  protected
    ...
    function GetAccValue(var Value: String): Boolean; override;
...
function SpStartsTextW(const ASubText, AText: String): Boolean;
...
function TSpTBXEditItemViewer.GetAccValue(var Value: String): Boolean;
begin
  Value := Item.Text;
  Result := True;
end;
